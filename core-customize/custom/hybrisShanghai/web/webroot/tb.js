...
var attributesAction = Ext.create('Ext.Action', {
    ...
    handler: function(widget, event) {
        ...
        if (rec) {
        	...
        	attributesstore.getProxy().url = 'showatrributes.do?typepk='+typepk;
    ...
    handler: function(widget, event) {
        ...
        if (rec) {
        	...
        	var store = Ext.create('Ext.data.Store', {
                ...
                proxy: {
                    type: 'ajax',
                    url: 'showitemsp.do?code='+co+'&mode=0',
                    reader: {
                        root: 'items',
    ...
    handler: function(widget, event) {
        ...
        if (rec) {
        	...
        	var store = Ext.create('Ext.data.Store', {
                ...
                proxy: {
                    type: 'ajax',
                    url: 'showitemsp.do?code='+co+'&mode=1',
                    reader: {
                        root: 'items',
                        totalProperty: 'totalCount',
                        type: 'json'
...
Ext.onReady(function() {
 ...
 // create the Grid, see Ext.
    ...
    function initCanvas(panel) {
        ...
        d3.json("showtypestree.do", function(json) {
        	  root = json;
        	  root.x0 = h / 2;
        	  root.y0 = 0;
