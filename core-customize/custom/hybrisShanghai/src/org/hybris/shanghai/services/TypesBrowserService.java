...
public interface TypesBrowserService
{
	/**
	 ...
	 */
	List<ComposedTypeModel> getComposedTypes();

	List<ComposedTypeModel> getComposedTypes(String like);
	...
	TypeModel getCollectionElementType(final String pk);
	 ...
	 */
	List<AttributeDescriptorModel> getAttributesofType(final String typepk);

	List<AttributeDescriptorModel> getAttributesofType(final String typepk, String like);
