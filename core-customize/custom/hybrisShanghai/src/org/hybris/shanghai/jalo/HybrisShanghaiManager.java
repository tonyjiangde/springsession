...
/**
 * This is the extension manager of the HybrisShanghai extension.
 */
public class HybrisShanghaiManager extends GeneratedHybrisShanghaiManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(HybrisShanghaiManager.class.getName());
	 ...
	 */
	public static HybrisShanghaiManager getInstance()
	{
		return (HybrisShanghaiManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				HybrisShanghaiConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public HybrisShanghaiManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of HybrisShanghaiManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of HybrisShanghaiManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of HybrisShanghaiManager called, current tenant: " + getTenant().getTenantID());
		}
	}
